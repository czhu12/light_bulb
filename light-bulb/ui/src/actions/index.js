...
export function getNextBatch(params) {
  return (dispatch) => {
    ...
    return fetch(`/lightbulb/api/batch?${query.toString()}`).then((response) => {
      if (!response.ok) {
...
export function getStats() {
  return (dispatch) => {
    dispatch(fetchStats());
    return fetch('/lightbulb/api/history').then((response) => {
      if (!response.ok) {
        throw Error(response.statusText);
      }
      return response.json();
...
export function getTask() {
  return (dispatch) => {
    dispatch(fetchTask());
    return fetch('/lightbulb/api/task').then((response) => {
      if (!response.ok) {
        throw Error(response.statusText);
      }
      return response.json();
...
export function submitJudgementToBackend(itemId, judgement, timeTaken, successCallback) {
  return (dispatch) => {
    ...
    return fetch('/lightbulb/api/judgements', {
      method: 'POST',
...
export function submitDataToScore() {
  return (dispatch, getState) => {
    ...
    return fetch('/lightbulb/api/score', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export function submitBatchJudgementsToBackend(judgements, timeTaken, isSearch) {
  return (dispatch) => {
    ...
    return fetch('/lightbulb/api/judgements/batch', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export const fetchNextBatchItemsBatch = () => {
  return (dispatch) => {
    ...
    return fetch(`/lightbulb/api/batch_items_batch`).then((response) => {
      if (!response.ok) {
        throw Error(response.statusText);
      }
      return response.json();
...
export const submitSearchBatchQuery = () => {
  return (dispatch, getState) => {
    ...
    dispatch(fetchBatchItems());
    return fetch(`/lightbulb/api/batch_items_batch?search_query=${searchQuery}`).then((response) => {
      if (!response.ok) {
        throw Error(response.statusText);
      }
      return response.json();
